...
def main():
    ...
    # features_file5 = 'features_shannon.csv'
    # features_file5 = 'features_100.csv'
    # features_file5 = 'features_chi_square.csv'
    # features_file5 = 'features_mean.csv'
    features_file5 = 'features_monte_carlo.csv'
    # features_file5 = 'features_sbcc.csv'

    # features_file6 = 'features_shannon.csv'
    # features_file6 = 'features_100.csv'
    # features_file6 = 'features_chi_square.csv'
    # features_file6 = 'features_mean.csv'
    # features_file6 = 'features_monte_carlo.csv'
    features_file6 = 'features_sbcc.csv'
            ...
            with open(features_file2, 'r', newline='', encoding='utf-8') as csvfile2:
                with open(features_file3, 'r', newline='', encoding='utf-8') as csvfile3:
                    with open(features_file4, 'r', newline='', encoding='utf-8') as csvfile4:
                        with open(features_file5, 'r', newline='', encoding='utf-8') as csvfile5:
                            with open(features_file6, 'r', newline='', encoding='utf-8') as csvfile6:
                                ...
                                next(reader5)
                                next(reader6)
                                for row1, row2, row3, row4, row5, row6 in zip(reader1, reader2, reader3, reader4, reader5, reader6):
                                    features.append([float(row1[0]), float(row1[1]), float(row2[0]), float(row3[0]), float(row4[0]), float(row5[0]), float(row6[0])])
    ...
    # print file names
    print(f'Features: {features_file1} and {features_file2} and {features_file3} and {features_file4} and {features_file5} and {features_file6}')
