...
DICTAMENES = {
    ...
    ("NETWALKER", "mailto"): ("INCLUIR", "RESUELTO 2026-08-23 con fuente externa (el catálogo por sí solo no alcanzaba): INCIBE-CERT (CERT nacional de España) dice «NetWalker ransomware, also known as Mailto or Koko»; PCrisk lo equipara en el título de su entrada. Deja de ser REVISAR"),
