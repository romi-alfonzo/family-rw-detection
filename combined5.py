...
def main():
                    ...
                    with open(features_file4, 'r', newline='', encoding='utf-8') as csvfile4:
                        with open(features_file5, 'r', newline='', encoding='utf-8') as csvfile5:
                            ...
                            for row1, row2, row3, row4, row5 in zip(reader1, reader2, reader3, reader4, reader5):
                                features.append([float(row1[0]), float(row1[1]), float(row2[0]), float(row3[0]), float(row4[0]), float(row5[0])])
    ...
    # print file names
    print(f'Features: {features_file1} and {features_file2} and {features_file3} and {features_file4} and {features_file5}')
